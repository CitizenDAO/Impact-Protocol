    ...
    ERC20Pausable
{
    ...
    constructor() ERC20("CitizenToken", "CDAO") ERC20Permit("CitizenToken") {
    ...
    function mint(address to, uint256 amount) public {
        require(
            ...
            "CitizenToken: must have minter role to mint"
        );
    ...
    function revokeMinting() public {
        require(
            hasRole(Roles.REVOKER_ROLE, _msgSender()),
            "CitizenToken: must have minter role to end minting"
        );
    ...
    function pause() public virtual {
        require(
            hasRole(Roles.PAUSER_ROLE, _msgSender()),
            "CitizenToken: must have pauser role to pause"
        );
    ...
    function revokePausing() public {
        require(
            hasRole(Roles.REVOKER_ROLE, _msgSender()),
            "CitizenToken: must have pauser role to end pausing"
        );
